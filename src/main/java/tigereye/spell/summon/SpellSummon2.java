...
public class SpellSummon2 extends Spell
{
    private final Constructor entityConstr;
    
    public SpellSummon2(final int par1, final String par2Name, final Class par3EntityClass) {
        super(par1);
    ...
    public void castSpell(final short par1Level, final World par2World, final EntityPlayer par3EntityPlayer) {
        ...
        try {
            final int[] xSpawnOffset = { -3, -2, -1, 0, 1, 0, 2, 3 };
            final int[] zSpawnOffset = { 0, 1, 2, 3, 0, -1, -2, -3 };
